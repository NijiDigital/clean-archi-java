...
@Import({
                fr.niji.example.trainresa.infrastructure.persistence.mapper.CommonJpaMapperImpl.class,
                fr.niji.example.trainresa.infrastructure.persistence.mapper.JourneyJpaMapperImpl.class,
                fr.niji.example.trainresa.infrastructure.persistence.mapper.JourneyWithAvailabilityMapperImpl.class,
                fr.niji.example.trainresa.infrastructure.persistence.query.JourneyJpaQuery.class
})
